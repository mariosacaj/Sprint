...
function toggleDetails() {
	...
	for(let i=0; i<allDetails.length; ++i) {
		if(allDetails[i].style.display == "block") {
...
document.getElementById("decolorize").style.display = "block";
}
...
document.getElementById("decolorize").style.display = "none";
}
...
function simplifyXML(text) {

	newText = text.replace(/<xsd:sequence.*>/g, "");
	newText = newText.replace(/<\/xsd:sequence.*>/g, "");
