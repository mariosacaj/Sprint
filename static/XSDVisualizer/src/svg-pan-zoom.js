...
module.exports = {
  ...
  _createZoomIn: function(instance) {
    ...
    zoomInBackground.setAttribute("width", "100"); // larger than expected because the whole group is transformed to scale down
    zoomInBackground.setAttribute("height", "100");
